...
def run_pretrain():
    ...
    if cfg.distribute == "true":
        if cfg.device_target == 'Ascend':
            ...
            rank = D.get_rank()
        ckpt_save_dir = os.path.join(cfg.train_url, 'ckpt_' + str(get_rank()))
    ...
    ds = create_bert_dataset(device_num, rank, cfg.do_shuffle, cfg.data_url, cfg.schema_dir, cfg.batch_size,
    ...
    if cfg.load_checkpoint_path:
        ...
        print("load!!!!!\n\n\n")
        print(cfg.load_checkpoint_path)
