...
def parse_args():
    ...
    parser.add_argument("--input_file", type=str, default="/data1/bert/Mindspore_bert/datas/bert_CN_data/datas/uniprot_swiss_prot.fasta",help="Input raw text file (or comma-separated list of files).")
    ...
    parser.add_argument("--output_file", type=str, default="/data1/bert/Mindspore_bert/datas/bert_CN_data/swiss_prot_mini.mindrecord",
...
def main():
    ...
    write_instance_to_example_files(instances, tokenizer, args.max_seq_length,
                                    args.max_predictions_per_seq, args.output_file.strip(".fasta")+".mindrecord")
