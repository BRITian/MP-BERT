...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=str, default="/data1/bert/Mindspore_bert/datas/Tnews",
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--task_name", type=str, default="tnews", help="The name of the task to train.")
    parser.add_argument("--vocab_file", type=str, default="/data1/bert/Mindspore_bert/datas/bert_CN_data/bert-base-chinese-vocab.txt",
                        help="The vocabulary file that the BERT model was trained on.")
    parser.add_argument("--output_dir", type=str, default="/data1/bert/Mindspore_bert/datas/Tnews/processed/",
