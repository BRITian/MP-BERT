...
def parse_args():
    ...
    parser.add_argument("--input_file", type=str, default="/data2/bert/mindspore/datas/swissprot_NSP/",help="Input raw text file (or comma-separated list of files).")
    ...
    parser.add_argument("--output_file", type=str, default="/data2/bert/mindspore/datas/swissprot_NNSP/",
...
file_list=glob.glob(os.path.join(args.input_file,"*.mindrecord"))
